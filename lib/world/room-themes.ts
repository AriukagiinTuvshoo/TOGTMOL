...
export const ROOM_THEMES: Record<DesignTheme, RoomTheme> = {
  ...
  rainy: {
    ...
    fontFamily: 'Georgia, "Times New Roman", serif',
    bodyBackgroundImage:
      "repeating-linear-gradient(115deg, transparent 0 35px, #5c868405 36px 37px)",
    decorations: {
      wallPlanks: false,
      windowTrees: false,
      sakura: false,
  ...
  space: {
    name: "Space Study",
    palette: palettes.space,
    ui: ui.space,
    fontFamily: 'Georgia, "Times New Roman", serif',
    bodyBackgroundImage: "radial-gradient(#aecbe51f 1px, transparent 1px)",
    bodyBackgroundSize: "43px 43px",
    decorations: {
      wallPlanks: false,
      windowTrees: false,
      sakura: false,
